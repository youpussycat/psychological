...
.add_content .teacher_name{
  position: absolute;
  left: 21px;
  top: 80px;
}

.add_content .teacher_profile{
  position: absolute;
  left: 28px;
  top: 304px;
}
...
.add_content .teacher_name span,
.add_content .teacher_profile span,
...
.add_content .teacher_name input{
  width: 200px;
  height: 30px;
  border: 1px solid rgba(187, 187, 187, 100);
  outline: none;
...
.add_content .teacher_profile textarea{
  width: 550px;
  height: 100px;
